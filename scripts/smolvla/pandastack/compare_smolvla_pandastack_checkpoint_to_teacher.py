...
def main():
    ...
    for i, sample_index in enumerate(sample_indices):
        ...
        base_l2_real = l2(base_action[:4], teacher_action[:4])
        checkpoint_l2_real = l2(checkpoint_action[:4], teacher_action[:4])
        ...
        comparisons.append({
            ...
            "base_to_teacher_l2_real_dims_0_3": base_l2_real,
            "checkpoint_to_teacher_l2_real_dims_0_3": checkpoint_l2_real,
            "l2_improvement_real_dims_0_3_positive_is_better": base_l2_real - checkpoint_l2_real,
            "base_to_teacher_l2_padded_dims_4_5": base_l2_padded,
            "checkpoint_to_teacher_l2_padded_dims_4_5": checkpoint_l2_padded,
            "l2_improvement_padded_dims_4_5_positive_is_better": base_l2_padded - checkpoint_l2_padded,
    ...
    result = {
        "ok": True,
        "purpose": "Compare SmolVLA base and trained checkpoint against PandaStack-v1 TQC teacher actions",
        "note": (
            "This checks numerical action proximity on dataset samples only. "
            "It does not prove task success in PandaStack-v1."
        ),
        "device": device,
        ...
        "mean_base_to_teacher_l2_real_dims_0_3": mean("base_to_teacher_l2_real_dims_0_3"),
        "mean_checkpoint_to_teacher_l2_real_dims_0_3": mean("checkpoint_to_teacher_l2_real_dims_0_3"),
        "mean_l2_improvement_real_dims_0_3_positive_is_better": mean("l2_improvement_real_dims_0_3_positive_is_better"),
        "mean_base_to_teacher_l2_padded_dims_4_5": mean("base_to_teacher_l2_padded_dims_4_5"),
        "mean_checkpoint_to_teacher_l2_padded_dims_4_5": mean("checkpoint_to_teacher_l2_padded_dims_4_5"),
        "mean_l2_improvement_padded_dims_4_5_positive_is_better": mean("l2_improvement_padded_dims_4_5_positive_is_better"),
